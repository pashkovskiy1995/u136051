...
<div class="text">
    <span>КП Деканат - корпоративный портал работающий в CMS 1С-Битрикс, который предназначен для учета студентов с помощью автоматизированной системы управления.</span>
</div>
