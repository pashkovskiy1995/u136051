...
class KPIEmployeeTable extends Entity\DataManager {
    ...
    public static function getTableEmployee()
    {
    ...
    public static function getMap()
    {
        return array(
            'ID' => array(
                ...
                'primary' => true,
                'autocomplete' => true,
                'title' => Loc::getMessage('KPI_EMPLOYEE_ID_FIELD'),
            ),
            ...
            'UF_VALUE' => array(
                ...
                'title' => Loc::getMessage('KPI_EMPLOYEE_UF_VALUE_FIELD'),
            ),
            'UF_EMPLOYEE' => new Entity\ReferenceField(
                'UF_EMPLOYEE',
            ...
            'UF_CREATED' => array(
                'data_type' => 'datetime',
                'title' => Loc::getMessage('KPI_EMPLOYEE_UF_CREATED_FIELD'),
            ),
            ...
            'UF_CHANGED' => array(
                'data_type' => 'datetime',
                'title' => Loc::getMessage('KPI_EMPLOYEE_UF_CHANGED_FIELD'),
            )
        );
    }
