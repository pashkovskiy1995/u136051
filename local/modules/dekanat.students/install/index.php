...
Битрикс CModule*/
Class dekanat_students extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "dekanat.students";
    var $MODULE_ID = "dekanat.students";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("dekanat.students_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("dekanat.students_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("dekanat.students_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("dekanat.students_PARTNER_URI");
    }
