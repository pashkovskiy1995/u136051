...
Битрикс CModule*/
Class dekanat_menu extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "dekanat.menu";
    var $MODULE_ID = "dekanat.menu";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("dekanat.menu_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("dekanat.menu_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("dekanat.menu_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("dekanat.menu_PARTNER_URI");
    }
